...
void RequestMidiFilename(std::wstring *returned_filename, std::wstring *returned_file_title)
{
   ...
   ofn.hwndOwner =       0;
   ofn.lpstrTitle =      L"SFBM: Choose a MIDI song to play   (No more than 100mil notes!)";
   ...
   options.windowTitle = CFSTR("SFBM: Choose a MIDI song to play   (No more than 100mil notes!)");
